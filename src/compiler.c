...
ParseRule rules[] = {
    ...
    [TOKEN_BANG_EQUAL]      = {NULL,     binary, PREC_EQAULITY},
    [TOKEN_EQUAL]           = {NULL,     NULL,   PREC_NONE},
    [TOKEN_EQUAL_EQUAL]     = {NULL,     binary, PREC_EQAULITY},
    [TOKEN_GREATER]         = {NULL,     binary, PREC_EQAULITY},
    [TOKEN_GREATER_EQUAL]   = {NULL,     binary, PREC_EQAULITY},
...
static void varDeclaration() {
    ...
    consume(TOKEN_SEMICOLON, "Epect ';' after variable declaration.");
